...
class ProductController extends Controller
{
    public function view(Request $request)
    {
        ...
        if(!empty($res2))
        {
            if(!empty($res1))
            {
                $res['data']=DB::table('product')->where('u_id',0)->get();
                return view('admin/products',$res);
            }
            else
            {
    ...
    public function add_product_view(Request $request)
    {
        ...
        return view('admin.forms.add_product',$res);
    }
    ...
    public function edit(Request $request,$id)
    {
        ...
        return view('admin/forms/edit_product',$res);
    }
    ...
    public function edit_attr_save(Request $request)
    {
        ...
        return redirect()->route('pro_attr1', ['id' => $p_id]);
    }
}
